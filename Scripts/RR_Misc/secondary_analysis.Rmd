...
```{r, eval = FALSE}
## No Pre-BMI adjustments, IEAA
ieaa_no_bmi_icc_weight_home <- lm(icc_weight_home ~ ieaa + gestage + measurement_age + iccsex + ses_pc1+ days_blood_preg, data = combined_data)
...
```{r, eval = FALSE}
## No Pre-BMI adjustments, EEAA
eeaa_no_bmi_icc_weight_home <- lm(icc_weight_home ~ eeaa + gestage + measurement_age + iccsex + ses_pc1+ days_blood_preg, data = combined_data)
...
```{r, eval = FALSE}
## No Pre-BMI adjustments, phenoage
age_accel_pheno_no_bmi_icc_weight_home <- lm(icc_weight_home ~ age_accel_pheno + gestage + measurement_age + iccsex + ses_pc1+ days_blood_preg, data = combined_data)
...
```{r, eval = FALSE}
## No Pre-BMI adjustments, grimage
age_accel_grim_no_bmi_icc_weight_home <- lm(icc_weight_home ~ age_accel_grim + gestage + measurement_age + iccsex + ses_pc1+ days_blood_preg, data = combined_data)
...
```{r}
## Pre-BMI adjustments, IEAA
ieaa_bmi_icc_weight_home <- lm(icc_weight_home ~ ieaa + gestage + measurement_age + iccsex + ses_pc1 + prebmiz+ days_blood_preg, data = combined_data)
...
sjPlot::tab_model(ieaa_bmi_icc_weight_home, ieaa_bmi_icc_length_home, ieaa_bmi_icc_armcircm_home, ieaa_bmi_icc_abdom_mean_home, ieaa_bmi_icc_headcirc_mean_home, ieaa_bmi_icc_total_skin_mean_home,  show.est = FALSE, show.se = FALSE, show.stat = TRUE, show.std = TRUE)
```
...
```{r}
## Pre-BMI adjustments, EEAA
eeaa_bmi_icc_weight_home <- lm(icc_weight_home ~ eeaa + gestage + measurement_age + iccsex + ses_pc1 + prebmiz+ days_blood_preg, data = combined_data)
...
sjPlot::tab_model(eeaa_bmi_icc_weight_home, eeaa_bmi_icc_length_home, eeaa_bmi_icc_armcircm_home, eeaa_bmi_icc_abdom_mean_home, eeaa_bmi_icc_headcirc_mean_home, eeaa_bmi_icc_total_skin_mean_home,  show.est = FALSE, show.se = FALSE, show.stat = TRUE, show.std = TRUE)
```
...
```{r}
## Pre-BMI adjustments, phenoage
age_accel_pheno_bmi_icc_weight_home <- lm(icc_weight_home ~ age_accel_pheno + gestage + measurement_age + iccsex + ses_pc1 + prebmiz+ days_blood_preg, data = combined_data)
...
sjPlot::tab_model(age_accel_pheno_bmi_icc_weight_home, age_accel_pheno_bmi_icc_length_home, age_accel_pheno_bmi_icc_armcircm_home, age_accel_pheno_bmi_icc_abdom_mean_home, age_accel_pheno_bmi_icc_headcirc_mean_home, age_accel_pheno_bmi_icc_total_skin_mean_home,  show.est = FALSE, show.se = FALSE, show.stat = TRUE, show.std = TRUE)
```
...
```{r}
## Pre-BMI adjustments, grimage
age_accel_grim_bmi_icc_weight_home <- lm(icc_weight_home ~ age_accel_grim + gestage + measurement_age + iccsex + ses_pc1 + prebmiz+ days_blood_preg, data = combined_data)
...
sjPlot::tab_model(age_accel_grim_bmi_icc_weight_home, age_accel_grim_bmi_icc_length_home, age_accel_grim_bmi_icc_armcircm_home, age_accel_grim_bmi_icc_abdom_mean_home, age_accel_grim_bmi_icc_headcirc_mean_home, age_accel_grim_bmi_icc_total_skin_mean_home,  show.est = FALSE, show.se = FALSE, show.stat = TRUE, show.std = TRUE)
...
```{r, eval = FALSE}
## No Pre-BMI adjustments, dn_am_adm_adj_age
dn_am_adm_adj_age_no_bmi_icc_weight_home <- lm(icc_weight_home ~ dn_am_adm_adj_age + gestage + measurement_age + iccsex + ses_pc1+ days_blood_preg, data = combined_data)
...
```{r}
## Pre-BMI adjustments, dn_am_adm_adj_age
dn_am_adm_adj_age_bmi_icc_weight_home <- lm(icc_weight_home ~ dn_am_adm_adj_age + gestage + measurement_age + iccsex + ses_pc1 + prebmiz+ days_blood_preg, data = combined_data)
...
sjPlot::tab_model(dn_am_adm_adj_age_bmi_icc_weight_home, dn_am_adm_adj_age_bmi_icc_length_home, dn_am_adm_adj_age_bmi_icc_armcircm_home, dn_am_adm_adj_age_bmi_icc_abdom_mean_home, dn_am_adm_adj_age_bmi_icc_headcirc_mean_home, dn_am_adm_adj_age_bmi_icc_total_skin_mean_home,  show.est = FALSE, show.se = FALSE, show.stat = TRUE, show.std = TRUE)
```
...
```{r, eval = FALSE}
## No Pre-BMI adjustments, dn_am_b2m_adj_age
dn_am_b2m_adj_age_no_bmi_icc_weight_home <- lm(icc_weight_home ~ dn_am_b2m_adj_age + gestage + measurement_age + iccsex + ses_pc1+ days_blood_preg, data = combined_data)
...
```{r} 
## Pre-BMI adjustments, dn_am_b2m_adj_age
dn_am_b2m_adj_age_bmi_icc_weight_home <- lm(icc_weight_home ~ dn_am_b2m_adj_age + gestage + measurement_age + iccsex + ses_pc1 + prebmiz+ days_blood_preg, data = combined_data)
...
sjPlot::tab_model(dn_am_b2m_adj_age_bmi_icc_weight_home, dn_am_b2m_adj_age_bmi_icc_length_home, dn_am_b2m_adj_age_bmi_icc_armcircm_home, dn_am_b2m_adj_age_bmi_icc_abdom_mean_home, dn_am_b2m_adj_age_bmi_icc_headcirc_mean_home, dn_am_b2m_adj_age_bmi_icc_total_skin_mean_home,  show.est = FALSE, show.se = FALSE, show.stat = TRUE, show.std = TRUE)
...
```{r, eval = FALSE} 
## No Pre-BMI adjustments, dn_am_cystatin_c_adj_age
dn_am_cystatin_c_adj_age_no_bmi_icc_weight_home <- lm(icc_weight_home ~ dn_am_cystatin_c_adj_age + gestage + measurement_age + iccsex + ses_pc1+ days_blood_preg, data = combined_data)
...
```{r} 
## Pre-BMI adjustments, dn_am_cystatin_c_adj_age
dn_am_cystatin_c_adj_age_bmi_icc_weight_home <- lm(icc_weight_home ~ dn_am_cystatin_c_adj_age + gestage + measurement_age + iccsex + ses_pc1 + prebmiz+ days_blood_preg, data = combined_data)
...
```{r, eval = FALSE} 
## No Pre-BMI adjustments, dn_am_gdf15adj_age
dn_am_gdf15adj_age_no_bmi_icc_weight_home <- lm(icc_weight_home ~ dn_am_gdf15adj_age + gestage + measurement_age + iccsex + ses_pc1+ days_blood_preg, data = combined_data)
...
```{r} 
## Pre-BMI adjustments, dn_am_gdf15adj_age
dn_am_gdf15adj_age_bmi_icc_weight_home <- lm(icc_weight_home ~ dn_am_gdf15adj_age + gestage + measurement_age + iccsex + ses_pc1 + prebmiz+ days_blood_preg, data = combined_data)
...
sjPlot::tab_model(dn_am_gdf15adj_age_bmi_icc_weight_home, dn_am_gdf15adj_age_bmi_icc_length_home, dn_am_gdf15adj_age_bmi_icc_armcircm_home, dn_am_gdf15adj_age_bmi_icc_abdom_mean_home, dn_am_gdf15adj_age_bmi_icc_headcirc_mean_home, dn_am_gdf15adj_age_bmi_icc_total_skin_mean_home,  show.est = FALSE, show.se = FALSE, show.stat = TRUE, show.std = TRUE)
...
```{r, eval = FALSE} 
## No Pre-BMI adjustments, dn_am_leptin_adj_age
dn_am_leptin_adj_age_no_bmi_icc_weight_home <- lm(icc_weight_home ~ dn_am_leptin_adj_age + gestage + measurement_age + iccsex + ses_pc1+ days_blood_preg, data = combined_data)
...
```{r} 
## Pre-BMI adjustments, dn_am_leptin_adj_age
dn_am_leptin_adj_age_bmi_icc_weight_home <- lm(icc_weight_home ~ dn_am_leptin_adj_age + gestage + measurement_age + iccsex + ses_pc1 + prebmiz+ days_blood_preg, data = combined_data)
...
sjPlot::tab_model(dn_am_leptin_adj_age_bmi_icc_weight_home, dn_am_leptin_adj_age_bmi_icc_length_home, dn_am_leptin_adj_age_bmi_icc_armcircm_home, dn_am_leptin_adj_age_bmi_icc_abdom_mean_home, dn_am_leptin_adj_age_bmi_icc_headcirc_mean_home, dn_am_leptin_adj_age_bmi_icc_total_skin_mean_home,  show.est = FALSE, show.se = FALSE, show.stat = TRUE, show.std = TRUE)
...
```{r, eval = FALSE} 
## No Pre-BMI adjustments, dn_am_packyrs_adj_age
dn_am_packyrs_adj_age_no_bmi_icc_weight_home <- lm(icc_weight_home ~ dn_am_packyrs_adj_age + gestage + measurement_age + iccsex + ses_pc1+ days_blood_preg, data = combined_data)
...
```{r} 
## Pre-BMI adjustments, dn_am_packyrs_adj_age
dn_am_packyrs_adj_age_bmi_icc_weight_home <- lm(icc_weight_home ~ dn_am_packyrs_adj_age + gestage + measurement_age + iccsex + ses_pc1 + prebmiz+ days_blood_preg, data = combined_data)
...
sjPlot::tab_model(dn_am_packyrs_adj_age_bmi_icc_weight_home, dn_am_packyrs_adj_age_bmi_icc_length_home, dn_am_packyrs_adj_age_bmi_icc_armcircm_home, dn_am_packyrs_adj_age_bmi_icc_abdom_mean_home, dn_am_packyrs_adj_age_bmi_icc_headcirc_mean_home, dn_am_packyrs_adj_age_bmi_icc_total_skin_mean_home,  show.est = FALSE, show.se = FALSE, show.stat = TRUE, show.std = TRUE)
...
```{r, eval = FALSE} 
## No Pre-BMI adjustments, dn_am_pai1adj_age
dn_am_pai1adj_age_no_bmi_icc_weight_home <- lm(icc_weight_home ~ dn_am_pai1adj_age + gestage + measurement_age + iccsex + ses_pc1+ days_blood_preg, data = combined_data)
...
```{r} 
## Pre-BMI adjustments, dn_am_pai1adj_age
dn_am_pai1adj_age_bmi_icc_weight_home <- lm(icc_weight_home ~ dn_am_pai1adj_age + gestage + measurement_age + iccsex + ses_pc1 + prebmiz+ days_blood_preg, data = combined_data)
...
sjPlot::tab_model(dn_am_pai1adj_age_bmi_icc_weight_home, dn_am_pai1adj_age_bmi_icc_length_home, dn_am_pai1adj_age_bmi_icc_armcircm_home, dn_am_pai1adj_age_bmi_icc_abdom_mean_home, dn_am_pai1adj_age_bmi_icc_headcirc_mean_home, dn_am_pai1adj_age_bmi_icc_total_skin_mean_home,  show.est = FALSE, show.se = FALSE, show.stat = TRUE, show.std = TRUE)
...
```{r, eval = FALSE} 
## No Pre-BMI adjustments, dn_am_timp1adj_age
dn_am_timp1adj_age_no_bmi_icc_weight_home <- lm(icc_weight_home ~ dn_am_timp1adj_age + gestage + measurement_age + iccsex + ses_pc1+ days_blood_preg, data = combined_data)
...
```{r} 
## Pre-BMI adjustments, dn_am_timp1adj_age
dn_am_timp1adj_age_bmi_icc_weight_home <- lm(icc_weight_home ~ dn_am_timp1adj_age + gestage + measurement_age + iccsex + ses_pc1 + prebmiz+ days_blood_preg, data = combined_data)
...
sjPlot::tab_model(dn_am_timp1adj_age_bmi_icc_weight_home, dn_am_timp1adj_age_bmi_icc_length_home, dn_am_timp1adj_age_bmi_icc_armcircm_home, dn_am_timp1adj_age_bmi_icc_abdom_mean_home, dn_am_timp1adj_age_bmi_icc_headcirc_mean_home, dn_am_timp1adj_age_bmi_icc_total_skin_mean_home,  show.est = FALSE, show.se = FALSE, show.stat = TRUE, show.std = TRUE)
...
```{r, eval = FALSE} 
## No Pre-BMI adjustments, dn_am_tl_adj_age
dn_am_tl_adj_age_no_bmi_icc_weight_home <- lm(icc_weight_home ~ dn_am_tl_adj_age + gestage + measurement_age + iccsex + ses_pc1+ days_blood_preg, data = combined_data)

dn_am_tl_adj_age_no_bmi_icc_length_home <- update(dn_am_tl_adj_age_no_bmi_icc_weight_home, icc_length_home ~ .)

dn_am_tl_adj_age_no_bmi_icc_armcircm_home <- update(dn_am_tl_adj_age_no_bmi_icc_weight_home, icc_armcircm_home ~ .)

dn_am_tl_adj_age_no_bmi_icc_abdom_mean_home <- update(dn_am_tl_adj_age_no_bmi_icc_weight_home, icc_abdom_mean_home ~ .)

dn_am_tl_adj_age_no_bmi_icc_headcirc_mean_home <- update(dn_am_tl_adj_age_no_bmi_icc_weight_home, icc_headcirc_mean_home ~ .)

dn_am_tl_adj_age_no_bmi_icc_total_skin_mean_home <- update(dn_am_tl_adj_age_no_bmi_icc_weight_home, icc_total_skin_mean_home ~ .)

sjPlot::tab_model(dn_am_tl_adj_age_no_bmi_icc_weight_home, dn_am_tl_adj_age_no_bmi_icc_length_home, dn_am_tl_adj_age_no_bmi_icc_armcircm_home, dn_am_tl_adj_age_no_bmi_icc_abdom_mean_home, dn_am_tl_adj_age_no_bmi_icc_headcirc_mean_home, dn_am_tl_adj_age_no_bmi_icc_total_skin_mean_home)
...
```{r} 
## Pre-BMI adjustments, dn_am_tl_adj_age
dn_am_tl_adj_age_bmi_icc_weight_home <- lm(icc_weight_home ~ dn_am_tl_adj_age + gestage + measurement_age + iccsex + ses_pc1 + prebmiz+ days_blood_preg, data = combined_data)

dn_am_tl_adj_age_bmi_icc_length_home <- update(dn_am_tl_adj_age_bmi_icc_weight_home, icc_length_home ~ .)

dn_am_tl_adj_age_bmi_icc_armcircm_home <- update(dn_am_tl_adj_age_bmi_icc_weight_home, icc_armcircm_home ~ .)

dn_am_tl_adj_age_bmi_icc_abdom_mean_home <- update(dn_am_tl_adj_age_bmi_icc_weight_home, icc_abdom_mean_home ~ .)

dn_am_tl_adj_age_bmi_icc_headcirc_mean_home <- update(dn_am_tl_adj_age_bmi_icc_weight_home, icc_headcirc_mean_home ~ .)

dn_am_tl_adj_age_bmi_icc_total_skin_mean_home <- update(dn_am_tl_adj_age_bmi_icc_weight_home, icc_total_skin_mean_home ~ .)

sjPlot::tab_model(dn_am_tl_adj_age_bmi_icc_weight_home, dn_am_tl_adj_age_bmi_icc_length_home, dn_am_tl_adj_age_bmi_icc_armcircm_home, dn_am_tl_adj_age_bmi_icc_abdom_mean_home, dn_am_tl_adj_age_bmi_icc_headcirc_mean_home, dn_am_tl_adj_age_bmi_icc_total_skin_mean_home,  show.est = FALSE, show.se = FALSE, show.stat = TRUE, show.std = TRUE)

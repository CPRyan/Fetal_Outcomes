...
```{r}
## No Pre-BMI adjustments, dn_am_b2m_adj_age
dn_am_b2m_adj_age_no_bmi_icc_weight_home <- lm(icc_weight_home ~ dn_am_b2m_adj_age + best_gestage + measurement_age + iccsex + ses_pc1, data = combined_data)
...
```{r} 
## No Pre-BMI adjustments, dn_am_tl_adj_age
dn_am_tl_adj_age_no_bmi_icc_weight_home <- lm(icc_weight_home ~ dn_am_tl_adj_age + best_gestage + measurement_age + iccsex + ses_pc1, data = combined_data)
...
```{r} 
## Pre-BMI adjustments, dn_am_tl_adj_age
dn_am_tl_adj_age_bmi_icc_weight_home <- lm(icc_weight_home ~ dn_am_tl_adj_age + best_gestage + measurement_age + iccsex + ses_pc1 + prebmiz, data = combined_data)

...
```{r} 
## No Pre-BMI adjustments, dn_am_tl_adj_age
dn_am_tl_adj_age_no_bmi_icc_weight_home <- lm(icc_weight_home ~ dn_am_tl_adj_age + gestage + measurement_age + iccsex + ses_pc1, data = combined_data)
...
```{r} 
## Pre-BMI adjustments, dn_am_tl_adj_age
dn_am_tl_adj_age_bmi_icc_weight_home <- lm(icc_weight_home ~ dn_am_tl_adj_age + gestage + measurement_age + iccsex + ses_pc1 + prebmiz, data = combined_data)
...
sjPlot::tab_model(dn_am_tl_adj_age_bmi_icc_weight_home, dn_am_tl_adj_age_bmi_icc_length_home, dn_am_tl_adj_age_bmi_icc_armcircm_home, dn_am_tl_adj_age_bmi_icc_abdom_mean_home, dn_am_tl_adj_age_bmi_icc_headcirc_mean_home, dn_am_tl_adj_age_bmi_icc_total_skin_mean_home)
